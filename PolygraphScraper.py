...
class PolygraphScraper(AbstractScraper):
    ...
    def __init__(self, scraper_name='Polygraph', scraper_url='https://www.polygraph.info'):
        self.scraper_name = scraper_name
        self.scraper_url = scraper_url
        super().__init__()

    def extract_claims_info(self, num_of_pages):
        page_soup = super().open_fact_check_page(self.scraper_url)
        ...
        for element in contents:
            ...
            # url
            url = self.scraper_url + element.find('a', class_='title')['href']
